...
（１）稼働日、出社は可能でしょうか？
はい、私もリモートワークしたくありません、入社すれば東京の会社の近くに引っ越すつもりです。

（２）使用技術言語について、ご縁があってご入社いただいた場合、PHP or Go or Python がメインになりますが、問題ないでしょうか？
はい、問題ないです。
去年、私は GitHub で自分で作ったプロジェクトを共有しました。このプロジェクトは簡単に言えば日本の株式市場のデータを分析し、いくつかのパターンに基づいて初期のスクリーニングを行い、これらの強力な株式の中からより深いスクリーニングを行うことを容易にします。
...
（３）副業について、弊社は副業 NG なのですが問題ないでしょうか？
はい、問題ないです。
...
9/20 (水) 13:30~15:00,18:00~21:00 間
9/21 (木) 18:00~21:00 間
9/22 (金) 12:30~14:00,18:30~21:00 間
