...
時間: 8 月 1 日（火）18 時開始（日本時間） 確認済み
時間: 2023 年 8 月 2 日（星期三）19:00 開始（日本時間） 確認済み
...
私は Web システムの開発や Linux 環境でのデータベースのメンテナンスが得意で、仕事でよく使うプログラミング言語は PHP、Go、JavaScript、Java、Python です
