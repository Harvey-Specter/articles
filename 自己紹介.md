...
会社のプロジェクトでは、アリババクラウド、Amazon の AWS、および Microsoft の Azure を使用したことがありますが、会社のプロジェクトのほとんどは中国向けなので、最も使用されているのはアリババクラウドです。AWS と Azure は中国では価格が高く、また、サーバーが海外にあるため、アクセス速度もあまり理想的ではありません。
