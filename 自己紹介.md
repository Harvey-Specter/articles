...
恥(は)ずかしいですが、その2つのテストは規定(きてい)の時間内に完了(かんりょう)できませんでした

また会えて嬉しいです、これから会え(あ)なくなるかもしれませんね

最初のテストは難しくはありませんが、少し複雑で、考慮(こうりょ)すべき条件(じょうけん)が多いと感じました

環境に慣(な)れるのに多くの時間を費(ひ)やし、完答(かんとう)できませんでした
...
私は現在ビザを持っていません
仕事が見つかり次第(しだい)、辞職(じしょく)とビザの手続きを行きます。この手続きには約 2 か月かかります。ですので、約 ２ か月ぐらい入社可能です
